...
token_list = ['0x1079257694A6215bD46918da74317C4A0AfA681B', '0xf340aC507F8E9DD94f26a33B0Ecd8dF9fA85AAf4', '0x950f5fE3Fcc6B8D4e8dfD364FDb1fc9c57B5617c']
list_length = len(token_list) / 3
...
#token1 = '0xf340aC507F8E9DD94f26a33B0Ecd8dF9fA85AAf4'    #add here
#token0 = '0x86eC65E53f1F13128566A54D3e0c7Bdf95BF0812'
#pair = '0x89b15326fB8C4bd0d0Ca04e9ebAB63e151c4cCFB'
...
counter = 0
for i in range(1):
    if token_list[counter+1] == '0xf340aC507F8E9DD94f26a33B0Ecd8dF9fA85AAf4':
        token0 = token_list[counter+1]
        token1 = token_list[counter+2]
        pair = token_list[counter]
    else: 
        token1 = token_list[counter+1]
        token0 = token_list[counter+2]
        pair = token_list[counter]
    counter += 3
    ...
    #deployer_address = '0xatester12345'
    ...
    #if token0 == '0xf340aC507F8E9DD94f26a33B0Ecd8dF9fA85AAf4':
    #    deploy = token1
    #    contract_creation_event = web3.eth.get_transaction_receipt(deploy)

    # Extract the deployer address from the event logs
    #    deployer_address = contract_creation_event['from']
    #elif token1 == '0xf340aC507F8E9DD94f26a33B0Ecd8dF9fA85AAf4':
    #    deploy = token0
    #    contract_creation_event = web3.eth.get_transaction_receipt(deploy)
    #    deployer_address = contract_creation_event['from']
    #else:
    #    deployer_address = 'Unknown as not paired with wsats'
    ...
    #print(f'{TokenPrice} and {token_name}')
